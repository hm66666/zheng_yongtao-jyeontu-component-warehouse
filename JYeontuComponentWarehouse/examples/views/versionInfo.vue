    ...
    data() {
        return {
            ...
            dataList: [
                ...
                {
                    title: "版本0.7.2 ~ 0.7.3（已发布）",
                    descript: "添加：图片滑块验证组件",
                    time: "2023-11-30",
                    icon: "7.3",
                },
                {
                    title: "版本0.6.9 ~ 0.7.1（已发布）",
                    descript: "添加：自动补全输入框",
                    time: "2023-11-15",
                    icon: "7.1",
                },
                ...
                {
                    title: "版本0.6.1 ~ 0.6.3（已发布）",
                    descript: "优化：评论组件多个共存问题，表情面板错位问题",
                    time: "2023-09-05",
                    icon: "6.1",
                },
                {
                    title: "版本0.6.0（已发布）",
                    descript: "优化：修复同一页面无法使用多个悬浮按钮问题",
                    time: "2022-11-27",
                    icon: "6.0",
                },
                {
                    title: "版本0.5.8 ~ 0.5.9（已发布）",
                    descript: "优化：桌宠组件使用在线资源",
                    time: "2022-11-24",
                    icon: "5.9",
                },
                {
                ...
                },
                {
                    title: "版本0.5.4（已发布）",
                    descript:
                        "优化：修复部分图标不显示问题；增加：添加自定义右键菜单栏功能",
                    time: "2022-11-14",
                    icon: "5.4",
                },
                {
                ...
                {
                    title: "版本0.3.9 ~ 0.4.0（已发布）",
                    descript: "优化：瀑布流图片容器组件添加图片点击回调事件",
                    time: "2022-04-06",
                    icon: "4.0",
                },
                {
                    title: "版本0.3.8（已发布）",
                    descript: "增加：瀑布流图片容器组件",
                    time: "2022-04-06",
                    icon: "3.8",
                },
                {
